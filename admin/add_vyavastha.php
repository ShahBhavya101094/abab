...
if (isset($_POST['update'])) {
    ...
    $query = "INSERT INTO `abab_vyavastha` ( `name`, `gender`, `mobile`, `sub_team`, `no_days`, `date_arrival`, `date_depature`, `status`) 
    VALUES ( ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('ssssssss', $name,$gender,$mobile ,$sub_team, $no_days, $arrival_date, $departure_date,$status);
    $stmt->execute();
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card required">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="mobile" id="mobile" maxlength="10" require
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="card required">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                    <input type="text" name="sub_team" id="sub_team"  placeholder="Sub Team Name" class="form-control"
                                            required="required">
                                    </div>
