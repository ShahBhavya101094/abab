        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Member's Account</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                            <a href="add_users.php"><button type="button" class="btn btn-block btn-md btn-success">Add New Member Details</button></a>
                                <hr>
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-hover table-bordered no-wrap">
                                        ...
                                        <td><?php echo $row->pranat;?></td>
                                        <td><?php echo $row->vibhag;?></td>
